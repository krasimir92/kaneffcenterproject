...
<script type='text/javascript' src='http://ajax.googleapis.com/ajax/libs/jquery/1.7.0/jquery.min.js?ver=1.7.0'></script>
   ...
   <div class="header">
	...
	<div class="events" >
		...
		<h2 align="center"><a class="effect-underline">Четиримата италиански тенори гостуват в Канев център на 24 юни</a></h2>
		
			<img src="pictures/chetirimata.jpg" class="imageprograma1" ><br>
			<p>Докоснете се до магията на италианското белканто с вокалния квартет „Четиримата италиански тенори“. </p>
			<p>Певците очароват почитателите си в цял свят с пленителните си гласове, артистичност и атрактивни изпълнения на популярни класически хитове. </p>
			<p>Тенорите ALBERTO URSO, FEDERICO SERRA, FEDERICO PARISI и ROBERTO CRESCA пристигат в България от Родината на белкантото – Италия, </p>
			<p>с поредица от концерти, част от тяхното световно турне. Не пропускайте „Четиримата италиански тенори“ в Русе на 24 юни в Канев Център от 19.00 часа.</p>
			<p>Ще имате възможността да чуете едни от най-популярните оперни арии, канцонети, дуети и хорове : </p>
			...
			<p>и много, много други, под съпровода на Врачанска Филхармония с диригенти Derek Gleeson и Христо Павлов.</p>
			<p>Viva la Musica!</p>
	</div>
