...
<script type='text/javascript' src='http://ajax.googleapis.com/ajax/libs/jquery/1.7.0/jquery.min.js?ver=1.7.0'></script>
   ...
   <div class="header">
					...
					<button class="buttonbg" value="Refresh Page" onclick="window.location.href='contacts.php'"><a class="language">БГ</a></button>
					<button class="buttonen" value="Refresh Page" onclick="window.location.href='contacts_en.php'"><a class="language">EN</a></button>
...
if(!empty($_POST["send"])) {
	...
	//if(!empty($insert_id)) {
	   $message = "Вашето съобшение е изпратено успешно.";
	   $type = "success";
...
<ul id="actionbuttons">
  ...
  <li><a href="recievedMessages.php"><button class="buttonprogram"><span>Съобщения</span></button></a></li>
