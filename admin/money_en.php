...
<script type='text/javascript' src='http://ajax.googleapis.com/ajax/libs/jquery/1.7.0/jquery.min.js?ver=1.7.0'></script>
   ...
   <div class="header">
					...
					<button class="buttonen" value="Refresh Page" onclick="window.location.href='money_en_en.php'"><a class="language">EN</a></button>
	...
	<div class="events" >
		...
		<h2 align="center"><a class="effect-underline">"Oh, that money"</a></h2>
		
			<img src="pictures/money.jpg" class="imageprograma2" >
				<p>Man and money - a sensitive, conflicting, even explosive relationship as old as the world. The eternal confrontation between "to have" or "to be." Behind this direct clash lies a contemporary comedy that is far from any instructive tone, entertaining us on the subject of what it is like to be happy.</p>
				<p>What is happiness - being a multimillionaire or being surrounded by your family and the people you love? This is the dilemma of Richard (Vasil Draganov) when he realizes that he is the winner of the big jackpot. He hesitates for a long time, and one night he gathers his closest relatives, his wife (Marina Mozzhukhina), his mother (Dobrina Getsova) and his colleague and best friend Etienne (Bozhidar Popchev) to share the news. </p>
				<p>A spectacle of how seemingly insignificant things can turn our lives, the trials of what we consider to be love, the destructive power of things that we attach most to when we lose our sense of measure. And of course, it's also about how little we know each other and how true exploration comes about only by going through powerful, shaking events together.</p>
  				<p>
But "Oh, that money" does not forget its main purpose - to entertain you from the first to the last moment. An excellent acting quartet, conducted by director Vladimir Petkov and housed in a home created by set designer Galina Abadzhimarinova. One spectacle worth "that money".</p>
	</div>
