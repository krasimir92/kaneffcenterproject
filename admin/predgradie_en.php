...
<script type='text/javascript' src='http://ajax.googleapis.com/ajax/libs/jquery/1.7.0/jquery.min.js?ver=1.7.0'></script>
   ...
   <div class="header">
	...
	<div class="events" >
		...
		<h2 align="center"><a class="effect-underline">Suburb</a></h2>
		
			<img src="pictures/predgradie.jpg" class="imageprograma1" >
				<p>Hovhannes Torosyan's performance
With the participation of: Alexander Mitev, Beatriz Blagoeva, Georgi Atanasov, Ivaylo Draganov, Ivelina Pavlova, Kostadin Zhekov, Milen Vangelov, Nedyalka Raeva, Petar Petrov, Sava Dragnev</p>
				<p>Why this play? Written in the 1990s, it still remains relevant to its topics. With their characters who are alive and real. They are among us. Maybe we are these characters, but we don't suspect. This is a story about Dreams, Love, Jealousy and Envy. The story of the insignificant - significant. A tragedy told in the language of the young, with the means of contemporary theater, in which the viewer is a witness, not an observer. Witness, because the story is of direct interest to him and does not concern him with superfluous "theatrical techniques", but focuses on the subject and the living characters in an ascetic way without saving anything. The suburbs as they are - this is our Suburb.</p>
				</div>
