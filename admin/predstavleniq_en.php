...
<script type='text/javascript' src='http://ajax.googleapis.com/ajax/libs/jquery/1.7.0/jquery.min.js?ver=1.7.0'></script>
   ...
   <div class="header">
	...
	<h2 align="center"><a class="effect-underline">PERFORMANCES</a></h2></p>
  ...
  <div class="gallery-image">
	...
	<img src="pictures/jordankahristovagallery.jpg" >
      <div class="transparent-box">
        <div class="caption">
		<a href="evergreen_en.php"> <p>See more</p></a>
        </div>
      </div> 
    </div>
    <div class="img-box">
	<img src="pictures/chetirimatagallery.jpg" >
      <div class="transparent-box">
        <div class="caption">
		<a href="chetirimata_en.php"> <p>See more</p></a>
        </div>
      </div>
    </div>
    <div class="img-box">
	<img src="pictures/pikapokagallery.jpg" >
      <div class="transparent-box">
        <div class="caption">
		<a href="pikapoka_en.php"> <p>See more</p></a>
        </div>
      </div>
    </div>
    <div class="img-box">
    <img src="pictures/ritongallery.jpg" >
      <div class="transparent-box">
        <div class="caption">
        <a href="chakamevi_en.php"> <p>See more</p></a>
        </div>
      </div> 
    </div>
    <div class="img-box">
    <img src="pictures/moneygallery.jpg" >
      <div class="transparent-box">
        <div class="caption">
        <a href="money_en.php"> <p>See more</p></a>
        </div>
      </div> 
    </div>
    <div class="img-box">
    <img src="pictures/predgradiegallery.jpg" >
      <div class="transparent-box">
        <div class="caption">
		<a href="predgradie_en.php"> <p>See more</p></a>
        </div>
      </div> 
    </div>
  </div>
