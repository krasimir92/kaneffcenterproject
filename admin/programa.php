...
<style>	
  ...
  height: 100px;
   ...
   <div class="header">
	...
	<h2 align="center"><a class="effect-underline">ПРОЖЕКЦИИ: КАНЕВ ЦЕНТЪР</a></h2></p>

	
        <ul id="actionbuttons">
		<li><a href="delete.php"><button class="buttonprogram"><span>Изтрий събитие</span></button></a></li>
		<li><a href="insert.php"><button class="buttonprogram"><span>Добави събитие</span></button></a>
	  </ul>
  
<?php include("query_programa.php"); ?>
...
<?php
    ...
    $predst = $_POST['id_predst'];
    if(mysqli_query($conn,"DELETE FROM `predstavleniq` WHERE `id_predst` = '$predst' ")){
