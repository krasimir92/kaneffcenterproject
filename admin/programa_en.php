...
<script type='text/javascript' src='http://ajax.googleapis.com/ajax/libs/jquery/1.7.0/jquery.min.js?ver=1.7.0'></script>
  ...
  height: 100px;
   ...
   <div class="header">
	...
	<ul id="actionbuttons">
		<li><a href="delete_en.php"><button class="buttonprogram"><span>Delete performance</span></button></a></li>
		<li><a href="insert_en.php"><button class="buttonprogram"><span>Add performance</span></button></a>
	  </ul>
...
<?php
    ...
    if(mysqli_query($conn,"DELETE FROM `predstavleniq_en` WHERE `id_predst` = '$predst' ")){
