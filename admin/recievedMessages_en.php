...
<script type='text/javascript' src='http://ajax.googleapis.com/ajax/libs/jquery/1.7.0/jquery.min.js?ver=1.7.0'></script>
   ...
   <div class="header">
  			 		...
  			 		<h1 align="center"><a href="index.php">KANEFF CENTER</h1></a>
					...
					<p class="welcome" >Welcome: <strong><?php echo $_SESSION['username']; ?></strong> / <a href="../index.php?logout='1'" style="color: red;">[logout]</a></p>
				
					<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
					<button class="buttonbg" value="Refresh Page" onclick="window.location.href='recievedMessages.php'"><a class="language">БГ</a></button>
					<button class="buttonen" value="Refresh Page" onclick="window.location.href='recievedMessages_en.php'"><a class="language">EN</a></button>
	...
	<div class="suobshteniq">
			<h2 align="center"><a class="effect-underline">RECIEVED MESSAGES</a></h2></p>
			<a href="delmessage_en.php"><button class="buttonmessage"><span>Delete message</span></button></a>
			
		<ul id="suobshteniq2">
			<li>	<h6>Mailer name</h6> </li>
			<li>	<h6>Mailer's email</h6></li>
			<li>	<h6>Subject</h6></li>
		</ul>

	</div>
	
<?php include("query_recievedMessages.php"); ?>
...
<?php
    ...
    $suobsht = $_POST['id_tblcontact'];
	if(mysqli_query($conn,"DELETE FROM `tblcontact` WHERE `id_tblcontact` = '$suobsht' ")){
