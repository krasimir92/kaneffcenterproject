...
<script type='text/javascript' src='http://ajax.googleapis.com/ajax/libs/jquery/1.7.0/jquery.min.js?ver=1.7.0'></script>
   ...
   <div class="header">
	...
	<div class="events" >
		...
		<h2 align="center"><a class="effect-underline">"ЧАКАМЕ ВИ С ЛЮБОВ", за да се потопите в магията ”ОБИЧ”, с песните на дует "Ритон”</a></h2>
		
			<img src="pictures/riton.jpg" class="imageprograma2" >
			<p>Любимците на няколко поколения българи Катя и Здравко, ще разкажат живота си чрез своята музика, стилна сценография и богато светлинно шоу,</p> 
			<p>на живо със своя бенд: Алекс Нушев-бас китара и аранжименти на песните от концерта, Юлиян Янев-клавишни и вокал, Щерион Пилидов-китари и вокал,</p> 
			<p>Георги Марков-ударни инструменти, доц. Миглена Ценова-Нушева-вокал, Христина Нейкова-вокал и Елена Сиракова-вокал.</p>
			<p>Някои от тях, като: “Твоята жена” и “Цял живот танго” вече са в ротация и спечелиха ласкавите оценки на публиката.</p>
			<p>Ще прозвучат и най-харесваните песни от последните албуми, като: “Златен Ритон”, “За последен път ти повтарям”, </p>
			<p>Живот като на кино” “Есенна тъга”, “Пристанище”, “До безсъзнание”, “Всички слаби места”, “Чакаме ви с любов”и др .</p>
			<p>В репертоара са и най любимите песни, изпяти от дуета, през годините, като: “Някога, но не сега”, Прегърни ме”, “Изповед”, </p>
			<p>“Накъдето ми видят очите”, “Елате ни на гости”, “Джалма”, “Болка от любов”, ”Цяла нощ” , “Дон Кихот” и много, много други…</p>
			<p><b>РУСЕ - “КАНЕВ ЦЕНТЪР” 25.09.2019г. 19.00ч.</b></p>
	</div>
		
	<a href="predstavleniq.php"><button class="buttonback"><span>Назад към представление</span></button></a>
