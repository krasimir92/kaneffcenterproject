...
<script type='text/javascript' src='http://ajax.googleapis.com/ajax/libs/jquery/1.7.0/jquery.min.js?ver=1.7.0'></script>
   ...
   <div class="header">
					...
					<button class="buttonbg" value="Refresh Page" onclick="window.location.href='evergreen.php'"><a class="language">БГ</a></button>
					<button class="buttonen" value="Refresh Page" onclick="window.location.href='evergreen_en.php'"><a class="language">EN</a></button>
	...
	<div class="events" >
		...
		<h2 align="center"><a class="effect-underline">Yordanka Hristova with a concert in Ruse</a></h2>
		
			<img src="pictures/jordankahristova.jpg" class="imageprograma1" >
				<p>On June 21 at 7 pm in Kaneff Center in Ruse will be presented "Favorite Evergreens with Yordanka Hristova".</p>
				<p>The concert is with the participation of the Orchestra of Opera Burgas with conductor Levon Manukyan. </p>
				<p>The program includes the eternal hits of Yordanka Hristova.</p>
	</div>
