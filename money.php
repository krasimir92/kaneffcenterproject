...
<script type='text/javascript' src='http://ajax.googleapis.com/ajax/libs/jquery/1.7.0/jquery.min.js?ver=1.7.0'></script>
   ...
   <div class="header">
					...
					<button class="buttonbg" value="Refresh Page" onclick="window.location.href='money.php'"><a class="language">БГ</a></button>
					<button class="buttonen" value="Refresh Page" onclick="window.location.href='money_en.php'"><a class="language">EN</a></button>
	...
	<div class="events" >
		...
		<h2 align="center"><a class="effect-underline">"Ох, тези пари"</a></h2>
		
			<img src="pictures/money.jpg" class="imageprograma2" >
				<p>Човекът и парите – една чувствителна, конфликтна, дори взривоопасна връзка, стара като света. Вечното противостоене между “да имаш” или “да бъдеш“. Зад този директен сблъсък се крие една съвременна комедия, която е далеч от какъвто и да е поучителен тон, забавлявайки ни върху темата – какво е да си щастлив.</p>
				<p>Какво е щастието – да си мултимилионер или да си заобиколен от семейството си и хората, които обичаш? Това е дилемата на Ришар (Васил Драганов), когато разбира, че той е печелившият на големия джакпот. Той дълго се колебае и една вечер събира най-близките си, жена си (Марина Мозжухина), майка си (Добрина Гецова) и своя колега и най-добър приятел Етиен (Божидар Попчев), за да сподели новината.</p>
				<p>Един спектакъл за това как привидно незначителни неща могат да преобърнат живота ни, за изпитанията пред онова, което считаме за любов, за разрушителната сила на нещата към които най-силно се привързваме, когато загубим усета за мярка. И разбира се, става дума и за това, колко малко се познаваме един друг и как истинското опознаване настъпва само и единствено преминавайки заедно през силни, разтърсващи събития.</p>
				<p>Но “Ох, тези пари“ не забравя своята основна цел – да ви забавлява от първия до последния момент. Един превъзходен актьорски квартет, дирижиран от режисьора Владимир Петков и разположен в дом създаден от сценографа Галина Абаджимаринова. Един спектакъл, който си струва „тези пари“.</p>
	</div>
