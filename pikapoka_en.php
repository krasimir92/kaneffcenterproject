...
<script type='text/javascript' src='http://ajax.googleapis.com/ajax/libs/jquery/1.7.0/jquery.min.js?ver=1.7.0'></script>
   ...
   <div class="header">
					...
					<button class="buttonbg" value="Refresh Page" onclick="window.location.href='pikapoka.php'"><a class="language">БГ</a></button>
					<button class="buttonen" value="Refresh Page" onclick="window.location.href='pikapoka_en.php'"><a class="language">EN</a></button>
	...
	<div class="events" >
		...
		<h2 align="center"><a class="effect-underline">Freedom dance studio's annual "Pika Poka and the Magic Button" will take place on June 29</a></h2>
		
			<img src="pictures/pikapoka.jpg" class="imageprograma1" >
			<p>Freedom dance studio's annual "Pika Poka and the Magic Button" will take place on June 29 at the Kaneff Center.</p>
			<p>Tickets are sold at the box office at the University of Ruse. We are expecting you!</p>
	</div>
