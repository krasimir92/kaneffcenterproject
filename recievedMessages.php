...
<style>	
  ...
  margin-left: auto;}
   ...
   <div class="header">
   					<h1 align="center"><a href="index.php"  class="effect-shine">КАНЕВ ЦЕНТЪР</h1></a>
					<p class="virtual" ><a class="effect-underline" href="https://www.google.bg/maps/@43.8542249,25.9688844,3a,75y,141.01h,101.11t/data=!3m7!1e1!3m5!1sULsNYe1kdbMAAAQuoP4EPg!2e0!3e2!7i13312!8i6656">Виртуална разходка</p></a>
					<img src="pictures//icons/location.jpg" width=15% class="imagelocation">
				
					<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
					<button class="buttonbg" value="Refresh Page" onclick="window.location.href='recievedMessages.php'"><a class="effect-underline">БГ</a></button>
					<button class="buttonen" value="Refresh Page" onclick="window.location.href='recievedMessages_en.php'"><a class="effect-underline">EN</a></button>
	...
	<div class="suobshteniq">
			<h2 align="center"><a class="effect-underline">ПОЛУЧЕНИ СЪОБЩЕНИЯ</a></h2></p>
		<ul id="suobshteniq2">
			<li>	<h6>Подател</h6> </li>
			<li>	<h6>Имейл на подател</h6></li>
			<li>	<h6>Тема на съобщението</h6></li>
